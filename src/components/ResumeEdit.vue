...
export default {
  ...
  data() {
    return {
      resume: {
        fullName: "Ахмедова Нодира Абдулатиповна",
        currentYear: "2019 ",
        currentMonth: "18 ноябр",
        bornYear: "14.09.1972",
        bornLive: "Тошкент шаҳри ",
        nation: "ўзбек",
        party: "йўқ",
        degree: "олий",
        endDegree: "1994 й. Низомий номли Тошкент давлат педагогика институти (кундузги)",
        specialty: "мусиқа ва ашула ўқитувчиси, тарбиявий ишлар методисти",
        academicDegree: "йўқ",
        academicTitle: "йўқ",
        knewForeign: "рус тили ",
        awards: "йўқ",
        member: "йўқ ",
        mehnatInfo: "2015-2018 йй. - Ўзбекистон Республикаси Ахборот технологиялари ва коммуникацияларини ривожлантириш вазирлиги Ишлар бошқармаси котибаси",
        relatives: {
          rateRelative: "Отаси",
          fullName: "Расулов Абдулатиф Абдухалилович",
          bornYear: "1946 йил,Тошкент шаҳри",
          jobPlace: "Пенсияда(«Безаш рассомчилик» корхонаси ходими)",
          livePlace: "Тошкент шаҳри,Шайҳонтохур тумани,Ибн Сино кўчаси,21-уй,"  },        infoArrey: [],
        relativeArrey: [],
      },
    };
  },
